package br.com.nozinho.web.validator;
...
@FacesValidator("validator.cpfValidador")
public class CpfValidator implements Validator {
     @Override
     public void validate(FacesContext arg0, UIComponent arg1, Object valorTela) throws ValidatorException {
          if (!"".equals(valorTela) && !validaCPF(String.valueOf(valorTela))) {
               FacesMessage message = new FacesMessage();
               message.setSeverity(FacesMessage.SEVERITY_ERROR);
               message.setSummary("O CPF informador é inválido!");
